Public Class frmVistaPrevia
    Private Sub frmVistaPrevia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'DBValyrianDataSet.ProductoMaxSalidas' Puede moverla o quitarla según sea necesario.
        Me.ProductoMaxSalidasTableAdapter.Fill(Me.DBValyrianDataSet.ProductoMaxSalidas)
