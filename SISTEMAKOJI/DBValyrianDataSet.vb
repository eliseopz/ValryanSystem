Partial Class DBValyrianDataSet
    ...
    Partial Public Class EntradasSalidasUsuarioDataTable
        Private Sub EntradasSalidasUsuarioDataTable_EntradasSalidasUsuarioRowChanging(sender As Object, e As EntradasSalidasUsuarioRowChangeEvent) Handles Me.EntradasSalidasUsuarioRowChanging
